...
WALL_MODELS = [ObjModel("maze3D_new/models/wall_tall_big.obj"),
               ObjModel("maze3D_new/models/wall_half_1_big.obj"),
               ObjModel("maze3D_new/models/wall_half_2_big.obj"),
               ObjModel("maze3D_new/models/wall_half_corner_1_bigger_tall.obj"),
...
VERTICAL_LINE_MODEL = ObjModel("maze3D_new/models/vertical_line.obj")
HORIZONTAL_LINE_MODEL = ObjModel("maze3D_new/models/horizontal_line.obj")
TORUS_MODEL = ObjModel("maze3D_new/models/torus.obj")
...
TEXT = [Texture("maze3D_new/textures/play.png"),
        Texture("maze3D_new/textures/1secs.png"),
        Texture("maze3D_new/textures/2secs.png"),
        Texture("maze3D_new/textures/3secs.png"),
        Texture("maze3D_new/textures/4secs.png"),
        Texture("maze3D_new/textures/5_secs.png"),
        Texture("maze3D_new/textures/goal_hit.png"),
        Texture("maze3D_new/textures/timeout.png")]
GREEN_LINE = Texture("maze3D_new/textures/green.png")
RED_LINE = Texture("maze3D_new/textures/red.png")
GREEN_TORUS = Texture("maze3D_new/textures/green.png")
RED_TORUS = Texture("maze3D_new/textures/red.png")
