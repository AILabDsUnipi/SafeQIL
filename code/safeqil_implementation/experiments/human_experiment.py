...
from safeqil_implementation.utils.env_utils import get_cost_sum_from_info_dict, close_env_debug_mode
...
class HumanExperiment(BaseExperiment):
    ...
    def human_alone_test(self):
        ...
        import mujoco
        import glfw
        from safeqil_implementation.utils.env_utils import capture_img_from_env_rendering
